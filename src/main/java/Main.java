...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < samples; i++) {
            ...
            testSignal[2 * i] = Math.sin(40 * 2 * Math.PI * t) + 0.5 * Math.sin(90 * 2 * Math.PI * t)
                    + 2 * Math.cos(100 * 2 * Math.PI * t);
            testSignal[2 * i + 1] = 0;
        ...
        for (int s = 0; s < complexTestSignal.length / 2; s++) {
            ...
            imaginaryPartOfTransformedComplexTestSignal[s] = complexTestSignal[2 * s].div(complexTestSignal.length)
                    .getIm();
        }
        ...
        for (int s = 0; s < realPartOfTransformedComplexTestSignal.length; s++) {
            ...
            derivativeFftImaginarySeries.add(freq[s] * 1 / (2 * (b - a)),
                    imaginaryPartOfTransformedComplexTestSignal[s]);
        }
        ...
        ChartFrame frame3 = new ChartFrame("XYLine Chart", ChartFactory.createXYLineChart("Test_FFT_real", "frequency",
                "amplitude", new XYSeriesCollection(testFftRealSeries)));
        ...
        ChartFrame frame4 = new ChartFrame("XYLine Chart", ChartFactory.createXYLineChart("Test_FFT_imaginary",
                "frequency", "amplitude", new XYSeriesCollection(testFftImaginarySeries)));
        ...
        ChartFrame frame5 = new ChartFrame("XYLine Chart", ChartFactory.createXYLineChart("derivative_FFT_real",
                "frequency", "amplitude", new XYSeriesCollection(derivativeFftRealSeries)));
        ...
        ChartFrame frame6 = new ChartFrame("XYLine Chart", ChartFactory.createXYLineChart("derivative_FFT_imaginary",
                "frequency", "amplitude", new XYSeriesCollection(derivativeFftImaginarySeries)));
